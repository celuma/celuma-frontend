...
// Céluma 1.3 Phase 1 to protect current report-rendering and search/sort behavior
...
export default defineConfig({
    ...
    test: {
        ...
        // golden tests from Phase 2 Story A2, and the real-browser E2E
        // suite from the post-Phase-2 remediation) — run via `npm run
