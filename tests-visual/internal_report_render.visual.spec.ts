...
/**
 * Céluma 1.3 Fase 2, Bloque E, Historia E17: real-browser coverage for the
 ...
 * headless Chromium instance during Historia E13 manual validation, fixed
...
const CASES: Array<{ key: string; name: string; expectedPages: number }> = [
    { key: "draftSingleSampleNoImages", name: "internal-render-legacy-corto", expectedPages: 1 },
    { key: "longContentMultipage", name: "internal-render-legacy-largo", expectedPages: 2 },
